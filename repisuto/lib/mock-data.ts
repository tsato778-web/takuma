...
export const CUSTOMERS: Customer[] = [
  ...
  { id: "cus_takahashi", storeId: STORE.id, customerNo: 12, name: "高橋 健", kana: "タカハシ ケン", phone: "090-7777-8888", gender: "M", birthday: "1990-11-03", firstSource: "ホットペッパー", registerMedia: "Web予約", funnel: "ホットペッパー → 初回カット → カラー", tags: [], messageTags: ["カラー", "30代"], ltv: 132000, lastVisitDate: "2026-04-28", mainStaffId: "stf_sato", firstStaffId: "stf_sato", lastStaffId: "stf_suzuki", monthlyMember: { active: false }, lineLinked: true, lineName: "ケン", tickets: [{ name: "カラー6回券", remaining: 1 }], visitCount: 8 },
  ...
  { id: "cus_saito", storeId: STORE.id, customerNo: 19, name: "斎藤 美月", kana: "サイトウ ミヅキ", phone: "080-8765-4321", gender: "F", birthday: "1991-02-18", firstSource: "Google", registerMedia: "Web予約", funnel: "Google → 初回カラー → リピート", tags: [], messageTags: ["カラー", "30代"], ltv: 64800, lastVisitDate: "2026-05-15", mainStaffId: "stf_sato", firstStaffId: "stf_sato", lastStaffId: "stf_sato", monthlyMember: { active: false }, lineLinked: true, lineName: "mizuki", tickets: [{ name: "カラー6回券", remaining: 0 }], visitCount: 5 },
  { id: "cus_kato", storeId: STORE.id, customerNo: 22, name: "加藤 結衣", kana: "カトウ ユイ", phone: "080-2222-3333", gender: "F", birthday: "1989-12-01", firstSource: "紹介", registerMedia: "公式LINE", funnel: "紹介 → 初回フェイシャル → 回数券 → 月額会員", tags: ["紹介"], messageTags: ["肩こり", "紹介", "フェイシャル", "30代"], ltv: 198000, lastVisitDate: "2026-05-18", nextVisitDate: "2026-05-27", nextVisitTime: "14:30", mainStaffId: "stf_suzuki", firstStaffId: "stf_suzuki", lastStaffId: "stf_suzuki", monthlyMember: { active: true, plan: "スタンダード会員 ¥11,000/月" }, lineLinked: true, lineName: "ゆい", tickets: [{ name: "フェイシャル4回券", remaining: 2 }], visitCount: 7 },
